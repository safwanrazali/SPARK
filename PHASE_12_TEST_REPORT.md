...
| **R11** | **Roles without a confirmed permission row** (Pegawai Kawalan Dokumen, Pegawai Penyelaras Rekod) currently see empty lists rather than an explicit "no access" page                                                                                                                                                                                                                                   | UX confusion, not a security hole — entity access is denied at query and route level (verified)                       | Confirm intended permissions, then implement                                                                                                              |
